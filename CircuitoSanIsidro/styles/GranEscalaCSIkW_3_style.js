...
var style_GranEscalaCSIkW_3 = function(feature, resolution){
    ...
    if (value >= 10000.000000 && value <= 20000.000000) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(1,230,255,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 5.548}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
            ...
            style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(107,174,214,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 5.548}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })]
